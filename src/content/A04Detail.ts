...
export default class A04DetailPage {
  ...
  getViewInfo() {
    ...
    return {
      viewA04Detail: {
        ...
        buildingYear: [this.state.requestInfo.buildingYear, '건물건축년도'],
        reasonTyNm: [this.state.requestInfo.reasonTyNm, '민원유형'],
  ...
  handleChangeBuildingYear(e: any) {
    this.setState({
      ...
      requestInfo: {
        ...
        contents: e.target.value.substring(0, 4)
      }
    });
    e.target.value = this.state.requestInfo.buildingYear.substring(0, 4);
  }
      ...
      <div id="form-mw23" class="row">
        ...
        <div class="form-mw-box display-block row">
          <div class="form-mv row">
            <ul>
              <li>
              	<label for="buildingYear" class="input-label"><span class="form-req">건물건축년도</span></label>
              	<input type="text" id="buildingYear" name="buildingYear" class="input-box input-w-2" title="건물건축년도" maxlength="4" placeholder="2022"
              		value="${that.state.requestInfo.buildingYear}"
              		onkeyup="cyberMinwon.state.currentModule.state.currentPage.handleChangeBuildingYear(event)" 
  		            onchange="cyberMinwon.state.currentModule.state.currentPage.handleChangeBuildingYear(event)">
              </li>
              <li>
  ...
  afterRender() {
    ...
    this.handleChangeReasonTy("reasonTy");
  }
