...
export default class A13DetailPage {
  ...
  getViewInfo() {
    ...
    return {
      viewA12Detail: {
        ...
        buildingYear: [this.state.requestInfo.buildingYear, '준공년도'],
  ...
  submitApplication() {
    ...
    fetch('POST', url, queryString, function (error: any, data: any) {
      // 에러가 발생한 경우
      if (error) {
        alert_msg("옥내급수관 진단 상담 신청이 정상적으로 처리되지 않았습니다.");
        return;
      }
      console.log(data);
      ...
      <div id="form-mw23" class="row">
        ...
        <div class="form-mw-box display-block row">
          <div class="form-mv row">
            <ul>
            	<li>
		          	<label for="buildingYear" class="input-label"><span class="form-req">준공년도</span></label>
		          	<input type="text" id="buildingYear" name="buildingYear" class="input-box input-w-2" title="준공년도" maxlength="4" placeholder="2022"
